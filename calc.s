...
opciones db "Por favor, digite el numero al lado de la figura a calcular:",cr,lf,"1) Cuadrado",cr,lf,"2) Rectangulo",cr,lf,"3) Triangulo (equilatero)",cr,lf,"4) Rombo",cr,lf,"5) Pentagono",cr,lf,"6) Hexagono",cr,lf,"7) Circulo",cr,lf,"8) Trapecio",cr,lf,"9) Paralelogramo$",cr,lf
area db "Area: $",cr,lf
perimetro db "Perimetro: $",cr,lf
pedirlado db "Por favor, digite el valor del lado: $",cr,lf
pedirbase db "Por favor, digite el valor de la base: $",cr,lf 
pediraltura db "Por favor, digite el valor de la altura: $",cr,lf
